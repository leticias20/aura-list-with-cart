      ...
      <div className='flex justify-between items-center'>
        <div>
          ...
          <div className='flex gap-2'>
            ...
            <p className='font-semibold text-Charcoal'>${(quantity*price).toFixed(2)}</p>
          </div>
        </div>
        <img onClick={()=>deleteItemfromCart(name)} className='size-[18px] border border-Silver rounded-full p-0.5 cursor-pointer' src="/assets/images/icon-remove-item.svg" alt="" />
      </div>
    </div>
  )
}
